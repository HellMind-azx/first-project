    ...
    <div className="home-page">
      ...
      <div className="buttons">
        <button className="write-to-me">
          <Link href="/write_me">Написать мне</Link>
        </button>
        <button className="look-works">
          <Link href="/our_works">Посмотреть работы</Link>
        </button>
      </div>
      ...
      <div className="blog-contents">
        <main className='container'>
          ...
          <section className='pages'>
            ...
            <button className="page-1">1</button>
            <button className="page-2">2</button>
            <button className="page-3">3</button>
